...
本作品は、生成 AI の活用を前提としたバイブコーディング形式の開発イベントで制作しました。実装コードの作成には生成 AI を使用しています。

瀧井はフロントエンド担当として、生成 AI への指示、画面・操作内容の確認、生成されたコードの動作検証、バックエンドとの API 連携・結合確認を行いました。すべてのコードを手作業で実装したものではなく、生成 AI を活用しながら、意図した画面・操作とシステム連携になっていることを確認しました。
